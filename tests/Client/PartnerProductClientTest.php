...
class PartnerProductClientTest extends TestCase
{
    ...
    public function testPostActiveStatus() : void
    {
        ...
        $activeStatusListRequest = ObjectSerializer::deserialize(
            $jsonRequestBody,
            '\Thecodebunny\OttoApi\Products\Model\ActiveStatusListRequest'
        );
    ...
    public function testGetSingleCategoryDefinition()
    {
        ...
        $this->assertInstanceOf('Thecodebunny\OttoApi\Products\Model\CategoryGroup', $result);
    }
    ...
    public function testGetProducts()
    {
        ...
        $this->assertContainsOnlyInstancesOf('Thecodebunny\OttoApi\Products\Model\ProductVariation', $result);
