...
namespace Thecodebunny\OttoApi\Cli\Client;

use Thecodebunny\OttoApi\Configuration;
use Thecodebunny\OttoApi\Oauth2\Oauth2Exception;
use Thecodebunny\OttoApi\PartnerApiClient;
use Thecodebunny\OttoApi\PartnerProductClient;
use Thecodebunny\OttoApi\PartnerShipmentClient;
    ...
    protected function main(Options $options)
    {
        ...
        switch ($options->getCmd()) {
            ...
            case 'uploadProduct':
                ...
                $productVariations = ObjectSerializer::deserialize($fileContents, '\Thecodebunny\OttoApi\Products\Model\ProductVariation[]');
            ...
            case 'upload-active-status':
                ...
                $activeStatusListRequest = ObjectSerializer::deserialize($fileContents, '\Thecodebunny\OttoApi\Products\Model\ActiveStatusListRequest');
