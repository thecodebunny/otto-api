...
use Thecodebunny\OttoApi\Shipments\Model\Link;
use Thecodebunny\OttoApi\Shipments\Model\Shipment;
use Thecodebunny\OttoApi\Shipments\Model\ShipmentList;
use Thecodebunny\OttoApi\Shipments\Model\ShipmentWithMinimumDetails;
use Thecodebunny\OttoApi\Shipments\Model\CreateShipmentRequest;
use Thecodebunny\OttoApi\Shipments\Model\CreateShipmentResponse;
use Thecodebunny\OttoApi\Shipments\Model\PositionItem;
...
class PartnerShipmentClient
{
    ...
    private function getOneShipment(string $url): ?Shipment
    {
            ...
            return ObjectSerializer::deserialize(
                ...
                '\Thecodebunny\OttoApi\Shipments\Model\Shipment'
            );
    }
    ...
    private function getShipmentList($href): ?ShipmentList
    {
        ...
        return ObjectSerializer::deserialize(
            $response->getBody()->getContents(),
            '\Thecodebunny\OttoApi\Shipments\Model\ShipmentList'
        );
    }
    ...
    public function createShipment(CreateShipmentRequest $shipment): ?CreateShipmentResponse
    {
        ...
        return ObjectSerializer::deserialize(
            $response->getBody()->getContents(),
            '\Thecodebunny\OttoApi\Shipments\Model\CreateShipmentResponse'
        );
    }
