...
class PartnerApiClient
{
    ...
    private ?PartnerQuantityClient $partnerQuantityClient = null;
     ...
     * Get the sub-client for accessing product API.
     *
     * @return PartnerQuantityClient
     */
    public function getPartnerQuantityClient(): PartnerQuantityClient
    {
        if (is_null($this->partnerQuantityClient)) {
            $this->partnerQuantityClient =
                new PartnerQuantityClient($this->configuration, $this->logger, $this->accessor);
        }

        return $this->partnerQuantityClient;
    }
