...
class ProductDescription implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'description' => 'string',
        'bulletPoints' => 'string[]',
        'attributes' => '\Thecodebunny\OttoApi\Products\Model\Attribute[]'
    ];
     ...
     * Gets attributes
     *
     * @return \Thecodebunny\OttoApi\Products\Model\Attribute[]|null
     */
     ...
     * Sets attributes
     *
     * @param \Thecodebunny\OttoApi\Products\Model\Attribute[]|null $attributes Lists all the descriptive information about a product variant a partner can provide. Must be provided in the form of a key values pair. Will be validated against the AttributeDefinitions from Category endpoint provided by Otto market.
     *
     * @return self
     */
