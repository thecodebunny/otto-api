...
namespace Thecodebunny\OttoApi\Orders\Api;
...
use Thecodebunny\OttoApi\Orders\ApiException;
use Thecodebunny\OttoApi\Orders\Configuration;
use Thecodebunny\OttoApi\Orders\HeaderSelector;
...
class OrdersApi
{
     ...
     *
     * @throws \Thecodebunny\OttoApi\Orders\ApiException on non-2xx response
     ...
     * @throws \Thecodebunny\OttoApi\Orders\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Thecodebunny\OttoApi\Orders\Model\PartnerOrderList
     */
     ...
     * @throws \Thecodebunny\OttoApi\Orders\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Thecodebunny\OttoApi\Orders\Model\PartnerOrderList, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Thecodebunny\OttoApi\Orders\Model\PartnerOrderList';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Thecodebunny\OttoApi\Orders\Model\PartnerOrderList',
     ...
     * @throws \Thecodebunny\OttoApi\Orders\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Thecodebunny\OttoApi\Orders\Model\PartnerOrder, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPartnerOrderByOrderNumberWithHttpInfo($order_number)
    {
        $returnType = '\Thecodebunny\OttoApi\Orders\Model\PartnerOrder';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Thecodebunny\OttoApi\Orders\Model\PartnerOrder',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
